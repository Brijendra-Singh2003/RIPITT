...
import { 
  ...
  Grid, Button, Tabs, Tab, Box, Chip, Avatar 
} from '@mui/material';
...
const ResearchAndDevelopmentPage = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 8 }}>
      ...
      <Card sx={{ mb: 6 }}>
        <CardContent>
          ...
          <Typography variant="body1" color="text.secondary">
            At IIIT Bhubaneswar, under the guidance of RIPITT (Research and Innovation Park for Information Technology and Telecommunications), we are committed to pushing the boundaries of technology and fostering innovation. Our research initiatives aim to address real-world challenges and contribute significantly to the global tech community.
          </Typography>
        </CardContent>
      </Card>
      ...
      <Box sx={{ mb: 6 }}>
        ...
        <Box sx={{ mt: 3 }}>
          {tabValue === 0 && (
            <Card>
              <CardContent>
                <Typography variant="h5" gutterBottom>Key Research Areas</Typography>
          ...
          {tabValue === 1 && (
            <Card>
              <CardContent>
                <Typography variant="h5" gutterBottom>Flagship Projects</Typography>
                <Typography variant="body2" color="text.secondary" paragraph>
      ...
      <Card sx={{ mb: 6 }}>
        <CardContent>
          <Typography variant="h5" gutterBottom>Our Impact</Typography>
          <Typography variant="body2" color="text.secondary" paragraph>
            Our research initiatives have led to numerous publications in prestigious journals, patents, and technology transfers to industry partners. We've collaborated with leading tech companies and government agencies, contributing to both economic growth and societal advancement.
          </Typography>
          <Grid container spacing={2}>
            <Grid item xs={6} sm={3}>
              <Chip label="20+" variant="outlined" avatar={<Avatar>P</Avatar>} />
              <Typography variant="body2" sx={{ mt: 1 }}>Patents filed in the last 3 years</Typography>
            </Grid>
            <Grid item xs={6} sm={3}>
              <Chip label="50+" variant="outlined" avatar={<Avatar>R</Avatar>} />
              <Typography variant="body2" sx={{ mt: 1 }}>Research papers published</Typography>
            </Grid>
            <Grid item xs={6} sm={3}>
              <Chip label="5" variant="outlined" avatar={<Avatar>T</Avatar>} />
              <Typography variant="body2" sx={{ mt: 1 }}>Successful technology transfers</Typography>
            </Grid>
            <Grid item xs={6} sm={3}>
              <Chip label="10+" variant="outlined" avatar={<Avatar>S</Avatar>} />
              <Typography variant="body2" sx={{ mt: 1 }}>Tech startups incubated</Typography>
            </Grid>
          </Grid>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent>
          <Typography variant="h5" gutterBottom>Join Our Research Community</Typography>
          <Typography variant="body2" color="text.secondary" paragraph>
            We're always looking for bright minds to join our research teams. Whether you're a student, academic, or industry professional, there are numerous ways to get involved with our cutting-edge research.
          </Typography>
